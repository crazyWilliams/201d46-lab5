...
function multiply(a, b) { //eslint-disable-line
  var result = a * b;
  var return_string2 = 'The product of ' + a +' and ' + b + ' is 45.';
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var first = sum(2, 3);
  var second = first[0];
  var last = sum(second, 4);

  


  return [last[0] , "2,3,4 was passed in as an array of numbers, and 9 is their sum."];
}
...
// Write your code here
var testMultiplArray = [2, 3, 4];

function multiplyArray(multArr) { //eslint-disable-line
  var first1 = multiply(2, 3);
  var second2 = first1[0];
  var last1 = multiply(second2, 4);




  return [last1[0] , "The numbers 2,3,4 have a product of 24."];
}
